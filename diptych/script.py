...
class SeparatePage:
    ...
    def split_two_waves(
        ...
        self.__images_found = find_images(
            image,
        ...
        (
            ...
            histogram_length,
            ecart,
        ) = split.found_split_line_with_line(
            image,
            self.__images_found,
            param1,
            debug,
        ...
        second = split.found_split_line_with_wave(
            image,
            param2,
            angle_1,
            debug,
        ...
        (
            self.__angle_split,
            pos_moy,
        ) = split.find_best_split_in_all_candidates(
            (angle_1, posx_1),
            second,
            histogram_length,
    ...
    def unskew_page(
        ...
        rotate_angle = unskew.find_rotation(
    ...
    def crop_around_data_in_page(
        ...
        crop_rect_size = crop_around_page(
            image, parameters, self.__angle_split - Angle.deg(90.0), debug
        )
        ...
        crop_rect2_size = crop_around_data(page_gauche_0, parameters, debug)
